...
# Creating a table for the simulation data generated by the loop
...
for(i in 1:iterations) {
  ...
  # TODO remove this, can just use the policy table data frame
...
initial_profit <- sum_policies
# for (i in 1:company_years){
#   if 
#   ROI_tracker[i,] <-
#   
# }
