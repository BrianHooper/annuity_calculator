...
# colnames(user_input, c("input_age_start", "input_age_end", "maturity_age", "yearly_annuity", "interest_rate", "term_length", "iterations"))
...
for (input_index in 1:length(user_input$input_age_start)) {
  ...
  yearly_annuity = user_input[input_index,4]
